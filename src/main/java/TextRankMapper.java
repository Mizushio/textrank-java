...
public class TextRankMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
...
//        String[] words = line.split(" +");
        ...
        List<String> sentenceList = HanLP.extractSummary(line, 10);
//        System.out.println(sentenceList);
        for (int i=0;i<sentenceList.size();i++)
        context.write(new Text(sentenceList.get(i)),new IntWritable(0));
